...
<body onload="window.print()">
    ...
    <h3 class="text-center" style="margin-bottom: 20px; font-weight: bold; text-decoration: underline;">DATA PENGGUNA</h3>
    ...
    <table class="table-data">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td align="center"><?php echo ($row['role'] == 'admin') ? 'Admin' : 'Tata Usaha'; ?></td>
            </tr>
            <?php } ?>
        </tbody>
    </table>
