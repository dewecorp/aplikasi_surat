...
/* Dashboard: 2 kolom + lebih ringkas di ponsel (admin & TU memakai halaman yang sama) */
...
@media (max-width: 767.98px) {
    ...
    .dashboard-widgets .text-xs {
        font-size: 0.62rem;
        line-height: 1.2;
    }
    .dashboard-widgets .h5 {
        font-size: 1rem;
    }
    .dashboard-widgets .fa-2x {
        font-size: 1.35em;
    }
    .dashboard-widgets .border-left-primary,
    .dashboard-widgets .border-left-success,
    .dashboard-widgets .border-left-info,
    .dashboard-widgets .border-left-warning {
...
<div class="container-fluid">
    ...
    <div class="row dashboard-widgets">
        <div class="col-6 col-md-6 col-xl-3 mb-3 mb-md-4">
